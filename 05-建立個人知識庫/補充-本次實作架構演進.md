...
Traditional RAG、Agentic RAG 與 Knowledge 的關係，請參閱 [補充教材：Knowledge、RAG 與文件使用模式](補充-Knowledge-RAG-與文件使用模式.md)

使用知識庫提問時，Open WebUI 會先找出與問題相關的文件內容，再將問題與相關內容交給對話模型產生回答
