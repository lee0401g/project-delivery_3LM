...
1. 啟動 Docker Desktop、Ollama 與 Open WebUI
2. 建立新對話並選擇 `gemma3:4b`
3. 使用 `#` 選擇第 05 單元建立的知識庫
4. 確認知識庫使用 Focused Retrieval
5. 輸入限制回答範圍的指示與一個明確問題
6. 開啟回答中的來源標記
7. 對照引用片段與原始文件
8. 示範如何判定直接支持、需要推論或資料不足
9. 以一個資料中沒有答案的問題測試模型
10. 使用短文件比較 Focused Retrieval 與 Full Context
